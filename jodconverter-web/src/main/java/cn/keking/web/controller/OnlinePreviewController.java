...
public class OnlinePreviewController {
    ...
    public String onlinePreview(String url, Model model, HttpServletRequest req) {
        FileAttribute fileAttribute = fileUtils.getFileAttribute(url);          //返回经过处理的文件属性类，带有基本属性信息
        req.setAttribute("fileKey", req.getParameter("fileKey"));
        model.addAttribute("pdfDownloadDisable", ConfigConstants.getPdfDownloadDisable());    //是否开启pdf下载
        model.addAttribute("officePreviewType", req.getParameter("officePreviewType"));     //设置预览格式
